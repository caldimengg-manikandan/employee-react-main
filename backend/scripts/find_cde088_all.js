...
async function findCDE088All() {
  try {
    ...
    appraisals.forEach(a => {
      console.log(`ID: ${a._id}, Year: ${a.year}, Status: ${a.status}, Incr: ${a.incrementPercentage}, Corr: ${a.incrementCorrectionPercentage}, Revised: ${a.revisedSalary}`);
    });
    process.exit(0);
  } catch (err) {
    console.error(err);
