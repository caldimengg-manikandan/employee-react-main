...
const Sidebar = ({ isOpen, onClose, isDesktopOpen = true, toggleDesktopSidebar }) => {
  ...
  const iconMap = {
    ...
    "Allowance Master": CalendarDaysIcon,
  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { name: "Support Dashboard", path: "/admin/support/dashboard", showForRoles: ["admin", "hr", "it_admin"], permission: "support_dashboard_access" },
      ]
    },
    {
      name: "Announcements",
