...
import HikCentralEmployees from '../components/HikCentralEmployees';
...
const EmployeeManagement = () => {
  ...
  const [activeTab, setActiveTab] = useState('local'); // 'local' or 'hikcentral'
      ...
      <div className="max-w-none xl:max-w-8xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          ...
          {activeTab === 'local' ? (
            ...
            /* HikCentral Employees Tab */
            <HikCentralEmployees />
          )}
        </div>
      </div>

      {/* Add/Edit Modal - Only for Local Employees */}
      {activeTab === 'local' && (
        <>
          <Modal
            isOpen={showModal}
          ...
          {/* View Employee Modal - Only for Local Employees */}
          {viewingEmployee && (
            <Modal
