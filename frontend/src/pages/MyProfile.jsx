  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      if (hasUserAccess && employeeDoc && employeeDoc._id) {
        res = await employeeAPI.updateEmployee(employeeDoc._id, payload);
      } else {
        res = await employeeAPI.updateMyProfile(payload);
      }
      ...
      const updatedUser = {
        ...
        profilePicture: updatedEmp?.profilePicture || ''
      };
      ...
      try {
        const refreshRes = await employeeAPI.getMyProfile();
        if (refreshRes.data) {
          setEmployeeDoc(refreshRes.data);
          const emp = refreshRes.data;
